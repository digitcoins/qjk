...
static const int64 MAX_MONEY =  10000000* COIN;// 50000000000 * COIN; 20151230
static const int64 MAX_MINT_PROOF_OF_WORK = 9999 * COIN;
static const int64 MIN_TXOUT_AMOUNT = MIN_TX_FEE;
inline bool MoneyRange(int64 nValue) { return (nValue >= 0 && nValue <= MAX_MONEY); }
static const int COINBASE_MATURITY_PPC = 500; // Adapted for qjk - same as it is set in Bitcoin, where QJK is 500
// Threshold for nLockTime: below this value it is interpreted as block number, otherwise as UNIX timestamp.
static const int LOCKTIME_THRESHOLD = 500000000; // Tue Nov  5 00:53:20 1985 UTC
static const int STAKE_TARGET_SPACING = 60*1; // qjk: 30 minute block spacing
static const int STAKE_MIN_AGE = 60 * 60 * 8; // qjk: Minimum age for coin age changed to 3 days
static const int STAKE_MAX_AGE = 60 * 60 * 24 * 90; // qjk: Stake age of full weight
static const int64 IPO_SHARES = 3000000* COIN;//50000000000 * COIN; // qjk: Total number of shares to create using proof of work (intented for IPO)
static const int64 PROOF_OF_WORK_BLOCKS = 4000;//; //2500 20151230 qjk: Block height of the last proof of work block  Ô¤ÍÚÍêµÄ¿éÊý
...
public:
    ...
    {
        // QJK: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    /** Amount of qjk spent by this transaction.
    ...
    /** Amount of qjk coming in to this transaction
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // QJK: get transaction coin age
...
public:
    ...
    // QJK: block signature - signed by coin base txout[0]'s owner
    ...
    // QJK: entropy bit for stake modifier if chosen by modifier
    ...
    // QJK: two types of block: proof-of-work or proof-of-stake
    ...
    // QJK: get max transaction timestamp
    ...
    bool AcceptBlock();
    bool GetCoinAge(uint64& nCoinAge) const; // QJK: calculate total coin age spent in block
...
public:
    ...
    unsigned int nFile;
    unsigned int nBlockPos;
    CBigNum bnChainTrust; // QJK: trust score of block chain
    int nHeight;
    int64 nMint;
    int64 nMoneySupply;

    unsigned int nFlags;  // QJK: block index flags
    enum  
    {
