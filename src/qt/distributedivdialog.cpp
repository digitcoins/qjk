...
const char* DistributeDivDialog::columnHeadings[] = {
    "qjk Address", "Shares", "QJK Address", "Dividend"
};
...
bool DistributeDivDialog::ConfirmDistribution()
{
    ...
    {
        QMessageBox::critical(this, "Error", QString("Unable to get QJK balance: %1").arg(error.what()));
        return false;
    }
    QString sQuestion = QString("%1 QJKS will be sent to %2 addresses in %3 transaction(s).\nYour current QJK balance is %4.\n\nAre you sure?").arg(
