        ...
        QWidget(parent)
{
    ...
    bitcoin_at_startup = new QCheckBox(tr("&Start qjk on system startup"));
    bitcoin_at_startup->setToolTip(tr("Automatically start qjk after the computer is turned on"));
    ...
    map_port_upnp->setToolTip(tr("Automatically open the qjk client port on the router. This only works when your router supports UPnP and it is enabled."));
    layout->addWidget(map_port_upnp);

    connect_socks4 = new QCheckBox(tr("&Connect through SOCKS4 proxy:"));
    connect_socks4->setToolTip(tr("Connect to the qjk network through a SOCKS4 proxy (e.g. when connecting through Tor)"));
...
//添加语言选项
	...
	lang->addItem(QString("简体中文"), QVariant("zh_CN"));
...
//添加语言选项结束
    ...
    display_addresses->setToolTip(tr("Whether to show qjk addresses in the transaction list"));
