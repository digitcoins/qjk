...
QString BitcoinUnits::name(int unit)
{
    switch(unit)
    {
    case BTC: return QString("QJK");
    case mBTC: return QString("m-QJK");
    case uBTC: return QString::fromUtf8("μ-QJK");
...
QString BitcoinUnits::description(int unit)
{
    ...
    {
    case BTC: return QString("QJK");
    case mBTC: return QString("Milli-QJK (1 / 1,000)");
    case uBTC: return QString("Micro-QJK (1 / 1,000,000)");
    default: return QString("???");
    }
}
