...
void BitcoinGUI::createActions()
{
    ...
    sendCoinsAction->setToolTip(tr("Send shares to a qjk address"));
    ...
    aboutAction->setToolTip(tr("Show information about qjk"));
    aboutAction->setMenuRole(QAction::AboutRole);
    aboutQtAction = new QAction(tr("About &Qt"), this);
    aboutQtAction->setToolTip(tr("Show information about Qt"));
    aboutQtAction->setMenuRole(QAction::AboutQtRole);
    optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
    optionsAction->setToolTip(tr("Modify configuration options for qjk"));
    optionsAction->setMenuRole(QAction::PreferencesRole);
    toggleHideAction = new QAction(QIcon(":/icons/peershares"), tr("Show/Hide &qjk"), this);
    toggleHideAction->setToolTip(tr("Show or hide the qjk window"));
    ...
    exportPeercoinKeysAction = new QAction(QIcon(":/icons/export"), tr("&Export QJK keys"), this);
    exportPeercoinKeysAction->setToolTip(tr("Export the QJK keys associated with the qjk addresses to QJK via RPC"));
...
void BitcoinGUI::createTrayIcon()
{
    ...
    trayIcon->setToolTip(tr("qjk client"));
    ...
    notificator = new Notificator(tr("qjk-qt"), trayIcon);
}
...
void BitcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
    ...
    {
        // Click on system tray icon triggers "show/hide qjk"
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to qjk network", "", count));
}
