...
static void handleRunawayException(std::exception *e)
{
    ...
    QMessageBox::critical(0, "Runaway exception", BitcoinGUI::tr("A fatal error occured. qjk can no longer continue safely and will quit.") + QString("\n\n") + QString::fromStdString(strMiscWarning));
    exit(1);
}
...
// TODO: implement qtipcserver.cpp for Mac and Windows
    ...
    app.setOrganizationName("QJK");
    app.setOrganizationDomain("qjkoin.com");
    if(GetBoolArg("-testnet")) // Separate UI settings for testnet
        app.setApplicationName("QJK-Qt-testnet");
    else
        app.setApplicationName("QJK-Qt");
    ...
    //QSplashScreen splash(QPixmap(":/images/splash.png")/*, 0*/);
